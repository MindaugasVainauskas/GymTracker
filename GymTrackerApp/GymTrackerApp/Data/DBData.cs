...
namespace GymTrackerApp.Data
{
    public class DBData
    {
        ...
        public static string DB_API_PATH = $"https://api.mlab.com/api/l/databases/{DB_NAME}/collections/{COLLECTION_NAME}";
        //URL to database collection
        public static string DB_PATH = $"https://api.mlab.com/api/l/databases/{DB_NAME}/collections/{COLLECTION_NAME}?apiKey={API_KEY}";
    }
}
